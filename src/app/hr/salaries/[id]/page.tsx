...
export default function SalaryDetailPage() {
  ...
  const handleDownloadPdf = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/hr/salaries/${params.id}/pdf`);
      ...
      let filename = `Fiche_Paie_${salary.period.month}_${salary.period.year}.pdf`;
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-2 bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-colors disabled:opacity-75 disabled:cursor-not-allowed"
            >
              {isDownloading ? (
                <>
