...
import { PlusIcon, MagnifyingGlassIcon, ArrowPathIcon, EyeIcon } from '@heroicons/react/24/outline';
                        ...
                        returns.map((ret) => (
                            <div key={ret._id} className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow border dark:border-gray-700 space-y-3">
                                ...
                                <div className="pt-3 border-t border-gray-100 dark:border-gray-700 flex justify-end">
                                    <Link
                                        href={`/purchases/returns/${ret._id}`}
                                        className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-50 text-indigo-700 hover:bg-indigo-100 dark:bg-indigo-900/30 dark:text-indigo-300 dark:hover:bg-indigo-900/50 rounded-lg transition-colors text-sm font-medium"
                                    >
