...
import { PlusIcon, MagnifyingGlassIcon, EyeIcon, PencilIcon, TrashIcon, ArrowDownTrayIcon, ChevronDownIcon, PhotoIcon, XMarkIcon, PlusCircleIcon, ArrowLeftIcon, ChevronLeftIcon, ChevronRightIcon } from '@heroicons/react/24/outline';
...
export default function PurchaseInvoicesPage() {
  ...
  }, [tenantId, statusFilter, page, searchParams, router]);
  ...
  async function fetchInvoices() {
    ...
    try {
      const url = statusFilter
        ? `/api/purchases/invoices?statut=${statusFilter}&page=${page}&limit=${LIMIT}`
        : `/api/purchases/invoices?page=${page}&limit=${LIMIT}`;
